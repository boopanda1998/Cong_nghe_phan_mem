...
public class NhanVienDAO{ 
  ...
  public static int  Insert(NhanVienDTO nhanVienDTO){
      try {
            Connection cons = DBConnect.getConnection();
            String sql = "INSERT INTO nhanvien(manv, ho, ten, gioitinh, ngaysinh, chucvu, luong, diachi, kinhnghiem, phongban, sdt,email) "
                    + "VALUES ( ?, ?, ?, ?, ?, ?, ?, ?, ?,?,?,?)";
            PreparedStatement ps = cons.prepareStatement(sql); 
            ...
            ps.setString(11, nhanVienDTO.getSdt());
            ps.setString(12, nhanVienDTO.getEmail());
   ...
   public static int Update(NhanVienDTO nhanVienDTO){
        try {
            Connection cons = DBConnect.getConnection();
           String sql="UPDATE nhanvien SET ho=?,ten=?,gioitinh=?,ngaysinh=?,chucvu=?,luong=?,diachi=?,kinhnghiem=?,phongban=?,sdt=?,email=? WHERE manv=?";
            PreparedStatement ps = cons.prepareStatement(sql);
            ps.setString(12, nhanVienDTO.getManv());
            ...
            ps.setString(10, nhanVienDTO.getSdt());
            ps.setString(11, nhanVienDTO.getEmail());
