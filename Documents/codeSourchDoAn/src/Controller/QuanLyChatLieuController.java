 ...
 //Kiem tra khoan trang
    public boolean checkNotNull() {
        ...
        if(jtfTenhang.getText() != null && !jtfTenhang.getText().equalsIgnoreCase("")){
            jtfTenhang.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(255, 0, 51), 2));
            checkTest = false;
        }else{
            jtfTenhang.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(255, 0, 0), 0));
        }
